/*
PROGRAMA:
  Programa que implementa una Simple Linked List
CREADORES:
...
int main() {
    ...
    list.insert(2,5); // Inserta un 5 en la posicion 1 ////Complejidad computacional O(n);

    cout << list.read(0) << std::endl; // imprime 1 en pos 0 ////Complejidad computacional O(n);
    cout << list.read(1) << std::endl; // imprime 5 en pos 1 ////Complejidad computacional O(n);
    cout << list.read(2) << std::endl; // imprime 2 en pos 2 ////Complejidad computacional O(n);
    cout << list.read(3) << std::endl; // imprime 4 en pos 3 ////Complejidad computacional O(n);
